...
def build_report_facts(state: WorkflowState) -> ReportFacts:
    ...
    return ReportFacts(
        ...
        change_area_denominator_km2=change.area_denominator_km2 if change else None,
        change_fraction_denominator=change.area_denominator_kind if change else None,
